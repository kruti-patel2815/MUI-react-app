          ...
          <Grid container spacing={2}>
            <Grid size={6}>
              <Box className="h-left">
                ...
                <p>
                  Risus feugiat in ante metus dictum. Nibh sit amet commodo
                  nulla facilisi nullam vehicula ipsum. Posuere urna nec
                  tincidunt praesent.
                </p>
                <br />
                <img src={h1}></img>
            ...
            <Grid size={6}>
              <Box className="h-right">
                ...
                <p>
                  ...
                  Ornare arcu odio ut sem. Adipiscing tristique risus nec
                  feugiat.
                </p>
                <br />
                <p>
                  Ornare arcu odio ut sem. Adipiscing tristique risus nec
                  feugiat. Tortor dignissim convallis aenean et tortor at risus
                  viverra adipiscing. Faucibus in ornare quam viverra orci
                  sagittis.
                </p>
                <br />
              ...
              <Slider {...test}>
                <div>
                  <p className="test-content">
                    ...
                    suscipit feliicitudin. Aenean sed rutrum purus. Nunc nec
                    magna laoreet, sodaleus bibens viverra vivamus edia.
                  </p>
